...
import sp.com.cleverclean.ui.HomeFragment;

public class APIdata extends AsyncTask<GPSTracker, Void, Void>{
    ...
    public APIdata(WeakReference<Context> contextRef, int SPLASH_DURATION) {
    ...
    protected void onPostExecute(Void unused) {
        ...
        if(context != null) {
            ...
            HomeFragment.home_forecast.setText(forecast);
            HomeFragment.home_location.setText(location);
            HomeFragment.home_temperature.setText(String.format("%.1f", temperature) + "°C");
        }
